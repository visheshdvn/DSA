...
class HuffmanCoding:
    ...
    def __make_dictionary(self, text):
        freq_dict = {}
        for char in text:
    ...
    def compress(self):
        ...
        with open(self.path, 'r+') as file, open(output_path, 'wb') as output:
            # make frequency ductionary using the text
            text = file.read()
            text = text.rstrip()
            freq_dict = self.__make_dictionary(text)

            # construct the heap from the frequncy_dict
            ...
            # create the encoded text using the code
